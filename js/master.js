...
ourGallery.forEach(img => {
    ...
    img.addEventListener('click', (e) => {
        ...
        if (img.alt !== null) { // To Put alt Before img
        ...
        // Set Image Source
        popupImage.src = img.src; // img that used in foreach loop
...
document.querySelector(".reset-options").onclick = function () {
    ...
    //localStorage.clear(); /*clear every item in local storage*/
...
toggleBtn.onclick = function (e) {
    ...
    // Stop Propagation
    e.stopPropagation(); // when click outside menu for example
